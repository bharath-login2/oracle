...
LeadDeatailsModelAdd leadDeatailsModelAddFromJson(String str) =>
    LeadDeatailsModelAdd.fromJson(json.decode(str));

String leadDeatailsModelAddToJson(LeadDeatailsModelAdd data) =>
...
class LeadDeatailsModelAdd {
  ...
  factory LeadDeatailsModelAdd.fromJson(Map<String, dynamic> json) =>
      LeadDeatailsModelAdd(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) {
    List<CallHistory> parseCallHistory(dynamic ch) {
      if (ch == null) return [];
      if (ch is List) {
        return List<CallHistory>.from(ch.map((x) => CallHistory.fromJson(x)));
      } else if (ch is Map && ch["lists"] is List) {
        return List<CallHistory>.from(
            ch["lists"].map((x) => CallHistory.fromJson(x)));
      }
      return [];
    }
