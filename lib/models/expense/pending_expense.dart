...
PendingExpenseModel pendingExpenseModelFromJson(String str) =>
    PendingExpenseModel.fromJson(json.decode(str));

String pendingExpenseModelToJson(PendingExpenseModel data) =>
...
class PendingExpenseModel {
  ...
  factory PendingExpenseModel.fromJson(Map<String, dynamic> json) =>
      PendingExpenseModel(
