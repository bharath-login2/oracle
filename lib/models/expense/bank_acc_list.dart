...
BankAccountList bankAccountListFromJson(String str) => BankAccountList.fromJson(json.decode(str));
...
class BankAccountList {
    ...
    factory BankAccountList.fromJson(Map<String, dynamic> json) => BankAccountList(
