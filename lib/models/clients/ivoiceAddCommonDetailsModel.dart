...
InvoiceAddCommonDetailsModel invoiceAddCommonDetailsModelFromJson(String str) =>
    InvoiceAddCommonDetailsModel.fromJson(json.decode(str));

String invoiceAddCommonDetailsModelToJson(InvoiceAddCommonDetailsModel data) =>
...
class InvoiceAddCommonDetailsModel {
  ...
  factory InvoiceAddCommonDetailsModel.fromJson(Map<String, dynamic> json) =>
      InvoiceAddCommonDetailsModel(
