class EditInvoiceDetailsModelTemp {
  Data? data;
  bool? status;
  String? message;

  EditInvoiceDetailsModelTemp({this.data, this.status, this.message});

  EditInvoiceDetailsModelTemp.fromJson(Map<String, dynamic> json) {
