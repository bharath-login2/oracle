...
InvoiceAddCommonDetailsModelGST invoiceAddCommonDetailsModelFromJson(
        String str) =>
    InvoiceAddCommonDetailsModelGST.fromJson(json.decode(str));

String invoiceAddCommonDetailsModelToJson(
        InvoiceAddCommonDetailsModelGST data) =>
    json.encode(data.toJson());

class InvoiceAddCommonDetailsModelGST {
  Data data;
  bool status;
  String message;

  InvoiceAddCommonDetailsModelGST({
    required this.data,
    required this.status,
    required this.message,
  });

  factory InvoiceAddCommonDetailsModelGST.fromJson(
