...
GetInvoiceSearchData getInvoiceSearchDataFromJson(String str) =>
    GetInvoiceSearchData.fromJson(json.decode(str));

String getInvoiceSearchDataToJson(GetInvoiceSearchData data) =>
...
class GetInvoiceSearchData {
  ...
  factory GetInvoiceSearchData.fromJson(Map<String, dynamic> json) =>
      GetInvoiceSearchData(
...
class Data {
  ...
  List<Staff> staff;
  List<CollectedStaff> collectedStaff;
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        collectedStaff: List<CollectedStaff>.from(
            json["collected_staff"].map((x) => CollectedStaff.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "collected_staff":
            List<dynamic>.from(collectedStaff.map((x) => x.toJson())),
...
class CollectedStaff {
  ...
  factory CollectedStaff.fromJson(Map<String, dynamic> json) => CollectedStaff(
        accountId: json["account_id"],
        accountName: json["account_name"],
      );
