...
RenewalDetailslModel renewalDetailslModelFromJson(String str) =>
    RenewalDetailslModel.fromJson(json.decode(str));

String renewalDetailslModelToJson(RenewalDetailslModel data) =>
...
class RenewalDetailslModel {
  ...
  factory RenewalDetailslModel.fromJson(Map<String, dynamic> json) =>
      RenewalDetailslModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        targetGroups: List<TargetGroups>.from(
            json["target_groups"].map((x) => TargetGroups.fromJson(x))),
      );
...
class TargetGroups {
  ...
  factory TargetGroups.fromJson(Map<String, dynamic> json) => TargetGroups(
        id: json["id"],
