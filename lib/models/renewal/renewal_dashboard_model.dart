...
RenewalDashboardModel renewalDashboardModelFromJson(String str) =>
    RenewalDashboardModel.fromJson(json.decode(str));

String renewalDashboardModelToJson(RenewalDashboardModel data) =>
...
class RenewalDashboardModel {
  ...
  factory RenewalDashboardModel.fromJson(Map<String, dynamic> json) =>
      RenewalDashboardModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        upcomingRenewals: json["upcoming_renewals"]??"",
        monthReport: List<MonthReport>.from(
            json["month_report"].map((x) => MonthReport.fromJson(x))),
      );
...
class MonthReport {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "amount": amount,
        "search_month":
            "${searchMonth.year.toString().padLeft(4, '0')}-${searchMonth.month.toString().padLeft(2, '0')}-${searchMonth.day.toString().padLeft(2, '0')}",
