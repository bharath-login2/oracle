                                ...
                                onTap: () async {
                                  ...
                                  if (connectivityResult ==
                                    ...
                                    if (username.text.isEmpty) {
                                      ...
                                      LoginModel object =
                                          await HttpService.login(username.text,
                                              password.text, firebaseToken);
                                      if (object.status == true) {
                                        ...
                                        if (object1.status == true) {
                                          ...
                                          Common.saveSharedPref(
                                              "viewLeadPermission",
                                              object1.data!.viewLead
                                                  .toString());
                                          Common.saveSharedPref(
                                              "updateLeadPermission",
                                              object1.data!.updateLead
                                                  .toString());
                                          Common.saveSharedPref(
                                              "deleteLeadPermission",
                                              object1.data!.deleteLead
                                                  .toString());
                                          Common.saveSharedPref(
                                              "phoneCallLogPermission",
                                              object1.data!.phoneCallLog
                                                  .toString());
                                          Common.saveSharedPref(
                                              "accessCallHistoryPermission",
                                              object1.data!.accessCallHistory
                                                  .toString());
                                          Common.saveSharedPref(
                                              "viewLeadCategoryPermission",
                                              object1.data!.viewLeadCategory
                                                  .toString());
                                          Common.saveSharedPref(
                                              "cloudCallPermission",
                                              object1.data!.cloudCall
                                                  .toString());
                                          Common.saveSharedPref(
                                              "createLeadCategory",
                                              object1.data!.createLeadCategory
                                                  .toString());
                                          Common.saveSharedPref(
                                              "updateLeadCategory",
                                              object1.data!.updateLeadCategory
                                                  .toString());
                                          Common.saveSharedPref(
                                              "deleteLeadCategory",
                                              object1.data!.deleteLeadCategory
                                                  .toString());
                                          Common.saveSharedPref(
                                              "accessCallRecordingPermission",
                                              object1.data!.accessCallRecording
                                                  .toString());
                                          Common.saveSharedPref(
                                              "createStaffPermission",
                                              object1.data!.createStaff
                                                  .toString());
                                          Common.saveSharedPref(
                                              "viewStaffPermission",
                                              object1.data!.viewStaff
                                                  .toString());
                                          Common.saveSharedPref(
                                              "updateStaffPermission",
                                              object1.data!.updateStaff
                                                  .toString());
                                          Common.saveSharedPref(
                                              "deleteStaffPermission",
                                              object1.data!.deleteStaff
                                                  .toString());
                                          Common.saveSharedPref(
                                              "viewStaffReportPermission",
                                              object1.data!.viewStaffReport
                                                  .toString());
                                          Common.saveSharedPref(
                                          ...
                                          Common.saveSharedPref(
                                              ...
                                              object1.data!.viewStaffDesignation
                                                  .toString());
                                          Common.saveSharedPref(
                                        ...
                                        Common.saveSharedPref(
                                            ...
                                            object.data!.name
                                                .toString()
                                                .toUpperCase());
                                        Common.saveSharedPref("userId",
                                            object.data!.userId.toString());
                                        Common.saveSharedPref("role",
                                            object.data!.role.toString());
                                        Common.saveSharedPref("roleId",
                                            object.data!.roleId.toString());
                                        Common.saveSharedPref(
                                            "multiBranch",
                                            object.data!.isMultiBranch
                                                .toString());
                                        Common.saveSharedPref(
