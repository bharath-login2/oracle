...
class _EditCustomRenewalState extends State<EditCustomRenewal> {
  ...
  TextEditingController collectedStaff = TextEditingController();
  ...
  getRenewalDetails() async {
    ...
    if (renewalDetails != null && renewalDetails!.status == true) {
      ...
      invoiceNumber.text = renewalDetails!.data.invoiceNumber;
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Visibility(
                  visible: renewalDetails!.data.invoiceNumber != "",
                  child: Padding(
                ...
                Visibility(
                  visible: renewalDetails!.data.invoiceDate != "",
                  child: Padding(
                    padding: const EdgeInsets.only(top: 16.0),
                    child: TextFormField(
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: SizedBox(
                                      width: MediaQuery.of(context).size.width *
                                          .4,
                                      child: Text(
                                          'The invoice amount has been modified. Receipts have already been generated for this invoice.Previous Amount ₹${renewalDetails!.data.totalAmount} ,New Amount ₹${totalProductCost.toString()}, Do you wish to proceed with the new amount?'),
                                    ),
                                    actions: [
                                      TextButton(
                                          onPressed: () async {
  ...
  addProduct() async {
    if (productName.contains(productNameController.text)) {
      ...
      } else if (double.parse(prodTax.text) > 100 ||
          double.parse(prodTax.text) < 0) {
        Common.toastMessaage('Enter valid tax percentage', Colors.red);
      } else {
        products.add({
                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              onTap: () {
                                ...
                                collectedId = filteredStaff[index].userId;
                                search.clear();
                                filteredStaff
