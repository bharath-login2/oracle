                                                                    ...
                                                                    Container(
                                                                      decoration: BoxDecoration(
                                                                          borderRadius: BorderRadius.circular(
                                                                              2),
                                                                          color: mainClientDetail!.data.invoice[index].status.toString() == 'Paid'
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          padding: const EdgeInsets
                                                                              ...
                                                                              bottom: 6),
                                                                          child: Text(
                                                                              mainClientDetail!.data.invoice[index].status.toString(),
                                                                              style: TextStyle(
                                                                      ...
                                                                      children: [
                                                                        InkWell(
                                                                          ...
                                                                          child:
                                                                              Container(
                                                                            decoration:
                                                                                BoxDecoration(borderRadius: BorderRadius.circular(2), color: Colors.green.shade100),
                                                                            child:
                                                                                Padding(
                                                                        ...
                                                                        mainClientDetail!.data.invoice[index].isPaid ==
                                                                                false
                                                                            ? InkWell(
                                                                                onTap: () {
                                                                                  Navigator.push(
