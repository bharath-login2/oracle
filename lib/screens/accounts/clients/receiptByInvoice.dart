...
class _ReceiptByInvoiceState extends State<ReceiptByInvoice> {
  ...
  getData() async {
    ...
    receiptList =
        await HttpService.invoiceReceptList(widget.token, widget.invoiceId);
    if (receiptList != null) {
      if (isSearch == true) {
        isSearch = false;
        if (mounted) {
                      ...
                      SingleChildScrollView(
                        child: Column(
                          children: [
                            Padding(
                              padding: const EdgeInsets.only(
                                  left: 12, right: 12, top: 12, bottom: 55),
                                                                    ...
                                                                    Navigator
                                                                      ...
                                                                      MaterialPageRoute(
                                                                          builder: (context) => WebViewPage(
                                                                              'image',
                                                                              receiptList!.data!.lists![index].uploadedFile.toString())),
                                                                    );
                                                                  },
                                                                  child:
                                                                      Container(
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              if (deleteReceipt.data == true) {
                                                                                ...
                                                                                if (context.mounted) {
                                                                                  Navigator.push(
                                                                                    context,
                                                                                    MaterialPageRoute(builder: (context) => ReceiptByInvoice(widget.token, widget.invoiceId)),
                                                                                  ).then((_) {
                                                                                    getData();
                                                                                  });
                                                                                }
