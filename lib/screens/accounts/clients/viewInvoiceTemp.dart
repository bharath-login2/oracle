...
class ViewInvoiceTemp extends StatefulWidget {
  String token;
  String invoiceId;
  String clientId;
  String invoiceNumber;

  ViewInvoiceTemp(this.token, this.invoiceId, this.clientId, this.invoiceNumber,
      {super.key});

  @override
  State<ViewInvoiceTemp> createState() => _ViewInvoiceTempState();
}

class _ViewInvoiceTempState extends State<ViewInvoiceTemp> {
