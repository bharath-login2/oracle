...
class _ReceiptListState extends State<ReceiptList> {
  ...
  getData() async {
    ...
    receiptList = await HttpService.receptList(
        widget.token, fDate.toString(), tDate.toString(), customerId);
    if (receiptList != null) {
                ...
                body: receiptList != null && customerList != null
                    ? Stack(
                        ...
                        children: [
                          SingleChildScrollView(
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.only(
                                      left: 12, right: 12, top: 12, bottom: 35),
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                          receiptList!.data!.lists![index].receiptDate
                                                                              .toString(),
                                                                          maxLines:
                                                                              2,
                                                                  ...
                                                                  Navigator
                                                                    ...
                                                                    MaterialPageRoute(
                                                                        builder: (context) => ViewReceipt(
                                                                            widget.token,
                                                                            receiptList!.data!.lists![index].id.toString(),
                                                                            receiptList!.data!.lists![index].clientId.toString(),
                                                                            receiptList!.data!.lists![index].receiptNumber.toString())),
                                                                  );
                                                                },
                                                                child:
                                                                    Container(
                                                                                ...
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  if (deleteReceipt.data == true) {
                                                                                    ...
                                                                                    if (context.mounted) {
                                                                                      Navigator.push(
                                                                                        context,
                                                                                        MaterialPageRoute(builder: (context) => ReceiptList(widget.token)),
                                                                                      );
                                                                                    }
                                                                                  } else {
                          ...
                          receiptList!.data!.lists!.isNotEmpty
                              ? Container(
                                  height: 50.0,
