...
class ViewInvoiceGst extends StatefulWidget {
  String token;
  String invoiceId;
  String clientId;
  String invoiceNumber;

  ViewInvoiceGst(this.token, this.invoiceId, this.clientId, this.invoiceNumber,
      {super.key});

  @override
  State<ViewInvoiceGst> createState() => _ViewInvoiceGstState();
}

class _ViewInvoiceGstState extends State<ViewInvoiceGst> {
