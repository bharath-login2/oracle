...
class EditInvoiceTemp extends StatefulWidget {
  String token;
  String invoiceId;
  String clientId;

  EditInvoiceTemp(this.token, this.invoiceId, this.clientId, {super.key});

  @override
  State<EditInvoiceTemp> createState() => _EditInvoiceTempState();
}

class _EditInvoiceTempState extends State<EditInvoiceTemp> {
  InvoiceAddCommonDetailsModelTemp? invDetails;
  EditInvoiceDetailsModelTemp? invoiceEditDetails;
  bool result = true;
                              ...
                              onTap: () async {
                                if (products.isEmpty) {
                                  ...
                                  EditInvoiceModel inv =
                                      await HttpService.editInvoiceTemp(body);
                                  if (inv.data == true) {
                                    Common.toastMessaage(
