...
import 'package:login2/screens/accounts/clients/editInvoiceGst.dart';
import 'package:login2/screens/accounts/clients/editInvoiceTemp.dart';
import 'package:login2/screens/accounts/clients/print_invoice_view_gst.dart';
...
import 'package:login2/screens/accounts/clients/viewInvoiceGst.dart';
...
class GSTInvoiceList extends StatefulWidget {
  String token;
  GSTInvoiceList(this.token, {super.key});

  @override
  State<GSTInvoiceList> createState() => _GSTInvoiceListState();
}

class _GSTInvoiceListState extends State<GSTInvoiceList> {
  String fDate = DateFormat('dd-MM-yyyy')
      .format(DateTime(DateTime.now().year, DateTime.now().month, 1));
  String tDate = DateFormat('dd-MM-yyyy').format(DateTime.now());
  InvoiceListModelGST? invoiceList;
  ...
  //   invoiceList = await HttpService.invoiceListGst(
  //       widget.token,
  ...
  //       typeId);
  //   if (invoiceList != null) {
  //     searchData = await HttpService.getInvoiceSearchGst(widget.token);
                                                    ...
                                                    SizedBox(
                                                      width:
                                                          MediaQuery.of(context)
                                                              ...
                                                              0.6,
                                                      child: Text(
                                                        "GST No : ${invoiceList!.data.lists[index].invoiceNumber}",
                                                        ...
                                                        Row(
                                                          children: [
                                                            InkWell(
                                                              ...
                                                              //     context,
                                                              //     MaterialPageRoute(
                                                              //         builder: (context) => ViewInvoiceGst(
                                                              //             widget
                                                              //                 .token,
                                                              //             invoiceList!
                                                              //                 .data
                                                                    ...
                                                                    onTap: () {
                                                                      if (invoiceList!
                                                                        ...
                                                                        Navigator
                                                                          ...
                                                                          context,
                                                                          MaterialPageRoute(
                                                                              builder: (context) => EditInvoiceGst(widget.token, invoiceList!.data.lists[index].id.toString(), invoiceList!.data.lists[index].clientId.toString())),
                                                                        ).then(
                                                                            (_) {
                                                                          getData();
                                                                        });
                                                                              ...
                                                                              actions: [
                                                                                ...
                                                                                TextButton(
                                                                                    onPressed: () async {
                                                                                      ...
                                                                                      DeleteInvoiceModel deleteInvoice = await HttpService.deleteInvoiceGst(widget.token, invoiceList!.data.lists[index].id);
