...
class InvoiceList extends StatefulWidget {
  ...
  String fromDash;
  String custName;
  InvoiceList(this.token, this.custId, this.fromDash, this.custName,
      {super.key});
...
String _calculateFilteredBalance(List<dynamic> filteredList) {
  ...
  void filterInvoices(String value) {
    setState(() {
      if (invoiceList != null) {
        if (value.isEmpty) {
          filteredInvoices = List.from(invoiceList!.data.lists);
        } else {
          filteredInvoices = invoiceList!.data.lists
              .where((item) =>
                  item.customerName
                      .toLowerCase()
    ...
    return showGeneralDialog(
      ...
      pageBuilder: (context, _, __) {
        return StatefulBuilder(builder: (context, setState) {
          // Create local search controller for this dialog
                        ...
                        showDialog(
                          ...
                          builder: (context) {
                            return StatefulBuilder(
                              ...
                              // Create local search controller for this nested dialog
                              TextEditingController nestedSearchController =
                                  TextEditingController();
  ...
  Widget _buildRightFilterSection(
    ...
    return StatefulBuilder(
      builder: (context, innerSetState) {
        switch (selectedTab) {
          case "Created By":
            return _buildCreatedBySection(innerSetState, context);
          case "Date Range":
            return _buildDateRangeSection(innerSetState, context);
          case "Customer":
            return _buildCustomerSection(innerSetState, context);
          case "Type":
            return _buildTypeSection(innerSetState, context);
          case "Status":
            return _buildStatusSection(innerSetState, context);
          default:
            return _buildCreatedBySection(innerSetState, context);
        }
      },
  ...
  Widget _buildCreatedBySection(StateSetter setState, BuildContext context) {
    return StatefulBuilder(
      builder: (context, innerSetState) {
        // Create local search controller for this section only
        TextEditingController createdBySearchController =
            TextEditingController();
        ...
        return ListView(
          children: [
            ...
            TextField(
              controller: createdBySearchController,
              decoration: const InputDecoration(
              ...
              child: filteredStaffs.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isSelected =
                            createdByIds.contains(staff.accountId);
            ...
            if (createdByNames.isNotEmpty) ...[
              ...
              InkWell(
                onTap: () {
                  createdByIds.clear();
                  createdByNames.clear();
                  createdBySearchController.clear();
                  filteredStaffs = List.from(staffs);
                  innerSetState(() {});
                  setState(() {});
                },
  ...
  Widget _buildStatusSection(StateSetter setState, BuildContext context) {
    return StatefulBuilder(
      builder: (context, innerSetState) {
        // Create local search controller for this section only
        TextEditingController statusSearchController = TextEditingController();
        ...
        return ListView(
          children: [
            ...
            const SizedBox(height: 16),
            TextField(
              controller: statusSearchController,
              decoration: const InputDecoration(
  ...
  Widget _buildStatusCheckbox(
      String status, String description, StateSetter innerSetState) {
  ...
  Future<dynamic> staffDialog(BuildContext context, String type) {
    ...
    // Create local search controller for this dialog
    TextEditingController staffDialogSearchController = TextEditingController();
    if (type == 'collected') {
              ...
              content: Column(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: TextField(
                      controller: staffDialogSearchController,
                      onChanged: (value) {
                        setState(() {
                          filteredStaffs = staffs
                              .where((item) => item.accountName
  ...
  Future<dynamic> typesDialog(BuildContext context) {
    return showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(builder: (context, setState) {
          // Create local search controller for this dialog
          TextEditingController typesDialogSearchController =
              TextEditingController();
            ...
            content: Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextField(
                    controller: typesDialogSearchController,
                    autocorrect: false,
                    keyboardType: TextInputType.visiblePassword,
                    autofocus: true,
                    onChanged: (value) {
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                          onTap: () {
                            ...
                            typesDialogSearchController.clear();
                            filteredTypes.clear();
  ...
  Future<dynamic> customerDialog(BuildContext context) {
    return showDialog(
      ...
      builder: (context) {
        return StatefulBuilder(builder: (context, setState) {
          // Create local search controller for this dialog
          TextEditingController customerDialogSearchController =
              TextEditingController();
            ...
            content: Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: TextField(
                    controller: customerDialogSearchController,
                    autocorrect: false,
                    keyboardType: TextInputType.visiblePassword,
                    autofocus: true,
                    onChanged: (value) {
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                          onTap: () {
                            ...
                            customerDialogSearchController.clear();
