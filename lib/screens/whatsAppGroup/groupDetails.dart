...
class _GroupDetailsState extends State<GroupDetails> {
  ...
  getData() async {
    ...
    contactGroupDetails =
        await HttpService.contactGroupDetails(widget.token, widget.id);
  ...
  Widget build(BuildContext context) {
    scheduledDate.text = DateFormat('dd-MM-yyyy HH:mm')
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => GroupInfoPage(widget.token,
                              widget.id, widget.groupName, widget.imageUrl),
                        ),
                      );
                    },
                    child: Container(
                          ...
                          Expanded(
                            child: ListView(
                              ...
                              children: List.generate(
                                ...
                                (index) {
                                  return MessageBox(
                                    message: contactGroupDetails!
                                        .data!.messages![index].caption,
                                    isImage: contactGroupDetails!
                                        .data!.messages![index].isImage,
                                    imgUrl: contactGroupDetails!
                                        .data!.messages![index].media,
                                  );
                                },
                              ),
                            ),
                                                                          ...
                                                                          SizedBox(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              decoration: InputDecoration(
                                                                                  ...
                                                                                  hintText: "Min Delay",
                                                                                  isDense: true,
                                                                                  border: OutlineInputBorder(borderSide: BorderSide(color: Colors.purple.shade100), borderRadius: BorderRadius.circular(10))),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                      ),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      SizedBox(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            await showDatePicker(context: context, initialDate: DateTime.now(), firstDate: DateTime.now(), lastDate: DateTime(2100)).then((selectedDate) {
                                                                              if (selectedDate != null) {
                                                                                showTimePicker(context: context, initialTime: TimeOfDay.now()).then((selectedTime) {
                                                                                  ...
                                                                                  if (selectedTime != null) {
                                                                                    scheduledDate.text = "$convertedNewDate ${selectedTime.format(context)}";
                                                                                  } else {}
                                                                                });
                                                                              }
                                                                            });
                                                                        ...
                                                                        if (_sendMessageController.text.isEmpty &&
                                                                          ...
                                                                          var formData =
                                                                            ...
                                                                            if (_imageFile ==
                                                                              ...
                                                                              "imageName": await MultipartFile.fromFile(_imageFile!)
                                                                          });
                                                                          ...
                                                                          if (object1.data ==
                                                                              true) {
                                                                            Common.toastMessaage(object1.message,
                                                                                Colors.green);
                                                                            getData();
                                                                            if (mounted) {
