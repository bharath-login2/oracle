  ...
  Widget build(BuildContext context) {
    return result == true
        ? Scaffold(
                    ...
                    child: contactGroup!.data!.isConfigured == true
                        ? Padding(
                            ...
                            child: configure!.data!.isExpired == false
                                ? SizedBox(
                                    child: contactGroup!
                                            .data!.listGroup!.isNotEmpty
                                        ? ListView.builder(
                                            itemCount: contactGroup!
                                                .data!.listGroup!.length,
            ...
            floatingActionButton: configure != null &&
                    contactGroup != null &&
                    contactGroup!.data!.isConfigured == true
                ? Padding(
