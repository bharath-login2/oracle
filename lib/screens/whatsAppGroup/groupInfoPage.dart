...
class GroupInfoPage extends StatefulWidget {
  ...
  String? groupname;
  String? imgUrl;
  GroupInfoPage(this.token, this.groupId, this.groupname, this.imgUrl,
      {super.key});
                                                              ...
                                                              onPressed:
                                                                ...
                                                                if (numbers.text
                                                                  ...
                                                                  Common.showProgressDialog(
                                                                      context,
                                                                      "Loading..");
                                                                  AddContactNumberModel
                                                                      addContact =
                                                                      await HttpService.addContactNumber(
                                                                          widget
                                                                              .token,
                                                                          numbers
                                                                              .text,
                                                              ...
                                                              onPressed:
                                                                ...
                                                                if (groupNameEdit
                                                                  ...
                                                                  Common.showProgressDialog(
                                                                      context,
                                                                      "Loading..");
                                                                  EditContactGroupModel
                                                                      editGroupName =
                                                                      await HttpService.editContactGroupName(
                                                                          widget
                                                                              .token,
                                                                          groupNameEdit
                                                                              .text,
                          ...
                          SliverList(
                                ...
                                children: [
                                  Text("Date Created",
                                      style: TextStyle(
                                          ...
                                          fontWeight: FontWeight.bold)),
                                  Text(
                                    groupInfo!.data!.createdDate.toString(),
                                    style: TextStyle(
                                        color: Colors.grey.shade500,
                                        fontWeight: FontWeight.bold),
                                  ),
                            ...
                            Padding(
                              ...
                              child: ListView.builder(
                                ...
                                itemCount:
                                    groupInfo!.data!.contactNumbers!.length,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          if (editNumber
                                                                              .text
                                                                              .isEmpty) {
                                                                            Common.toastMessaage('Number cannot empty',
                                                                                Colors.red);
                                                                          } else {
                                                                            Common.showProgressDialog(context,
                                                                                "Loading..");
                                                                            EditContactNumberModel
                                                                                editNumber1 =
                                                                                await HttpService.editContactNumber(widget.token, editNumber.text, groupInfo!.data!.contactNumbers![i].id.toString());
                                                                            if (editNumber1.data ==
                                                                                true) {
                                                                              Common.toastMessaage(editNumber1.message, Colors.green);
                                                                              Navigator.push(
                                                                                context,
                                                                                MaterialPageRoute(builder: (context) => GroupInfoPage(widget.token, widget.groupId, widget.groupname, widget.imgUrl)),
                                                                              );
                                                                            } else {
                                                                              Common.toastMessaage(editNumber1.message, Colors.red);
              ...
              TextButton(
                  onPressed: () async {
                    ...
                    DeleteContactGroupModel delete =
                        await HttpService.deleteContactGroup(
              ...
              Positioned(
                ...
                child: IconButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => GroupList(token)),
                    );
                  },
