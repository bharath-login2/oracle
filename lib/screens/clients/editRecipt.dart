        ...
        SingleChildScrollView(
          child: Column(
            children: [
              ...
              receiptDetails!.data!.uploadedImg==''? Container(
                child: paymentMethod=='2'? Container(
                              ...
                              children: [
                                Container(
                                  ...
                                  BoxDecoration(
                                    image: DecorationImage(
                                      fit: BoxFit.fitWidth,
                                      image: NetworkImage(receiptDetails!.data!.uploadedImg.toString(),
                                      ),
                                    ),
                                  ),
                                  // Add your image widget here
              ...
              InkWell(
                onTap: () async {
                  ...
                  else if(double.parse(payAmount.text)>double.parse(receiptDetails!.data!.checkAmount.toString()))
                  {
                    Common.toastMessaage(
