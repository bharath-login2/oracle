            ...
            children: [
                                                ...
                                                TextField(
                                                  ...
                                                  onChanged:
                                                    ...
                                                    setState(
                                                            () {
                                                          filteredItems =
                                                              items.where((item) => item.staffName!.toLowerCase().contains(value.toLowerCase())).toList();
                                                        });
                                                  },
                                                  decoration:
                                                  ...
                                                  itemBuilder:
                                                    ...
                                                    return ListTile(
                                                        ...
                                                        title: SizedBox(
                                                            ...
                                                            child: Text(filteredItems[index].staffName!,overflow: TextOverflow.ellipsis,)));
                                                  },
                                                ),
                                              )
                                            ],
                  ...
                  children: [
                    TableRow(
                      ...
                      children:  [
                        ...
                        Padding(
                          padding: const EdgeInsets.all(8.0),
                          child: Text(double.parse(receiptDetails!.data!.amountDue.toString()).toStringAsFixed(2),
                                ...
                                child:  Padding(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      const Center(child: Text('Change File')),
                                    ],
                                  ),
                                )),
                          ),
              ...
              InkWell(
                onTap: () async {
                  ...
                  else if(double.parse(payAmount.text)>double.parse(receiptDetails!.data!.amountDue.toString()))
                    {
                      Common.toastMessaage(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(object.message.toString(),style: const TextStyle(fontSize: 15,fontWeight: FontWeight.w400),),
                                                    const SizedBox(height: 15,),
                                                    Row(
                                                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                      children: [
