...
//
// class CampaignsDetailsPage extends StatefulWidget {
//   String? token;
//   String? groupId;
//   String? groupName;
//   String? imgUrl;
//   CampaignsDetailsPage(this.token,this.groupId,this.groupName,this.imgUrl, {super.key});
//
//   @override
//   _CampaignsDetailsPageState createState() => _CampaignsDetailsPageState();
// }
//
// class _CampaignsDetailsPageState extends State<CampaignsDetailsPage> {
//
//   bool? result = true;
//   bool? result1 = true;
...
//           context,
//           MaterialPageRoute(
//               builder: (context) => CampaignsChatScreen(groupId: widget.groupId.toString(),
//               )),
//         );
//         return true;
//       },
...
//                   delegate: WhatsappAppbar(MediaQuery.of(context).size.width,'',widget.token!),
//                   pinned: true,
//                 ),
//                 SliverToBoxAdapter(
//                   child: Column(
