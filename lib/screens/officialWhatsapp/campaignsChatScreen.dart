  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: officialMessageModel == null && templateModel == null
            ? const SizedBox()
            : Container(
                                        ...
                                        children: [
                                          officialMessageModel!
                                              ...
                                              : officialMessageModel!
                                                  ...
                                                  : officialMessageModel!.messages![index].messageText!.format ==
                                                          'DOCUMENT'
                                                      ? Container(
                                                          width:
                                                      ...
                                                      : officialMessageModel!
                                                                  ...
                                                                  .format ==
                                                              'TEXT'
                                                          ? officialMessageModel!.messages![index].messageText!.url == ''
                                                              ? const SizedBox()
                                                              : Padding(
