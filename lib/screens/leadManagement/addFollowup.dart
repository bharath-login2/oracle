                              ...
                              child: Row(
                                ...
                                children: [
                                   SizedBox(width:MediaQuery.of(context).size.width * 0.3,
                                    child:const Text('Priority',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),),
                                  SizedBox(
                                              ...
                                              child: Column(
                                                children: [
                                                  SizedBox(
                                                    ...
                                                    width: 24,
                                                    child: Radio(
                                                      activeColor:int.parse(priorityId)==1?Colors.grey: int.parse(priorityId)==2?Colors.green: int.parse(priorityId)==3?Colors.red:Colors.purple ,
                                                        value: int.parse(commonDetails!
                                                            .data.priority[i].priorityId.toString()),
                                                        groupValue: int.parse(priorityId),
                                                        onChanged: (int? value) {
                                                  ...
                                                  Text(commonDetails!
                                                      .data.priority[i].priority.toString()),
                                                ],
                                              ),
                                            ),
                                          );
                                  ...
                                  if (callResultId == '') {
                                    ...
                                    AddLeadFollowupModel object1 =
                                        await HttpService.addLeadsFollowup(
                                            ...
                                            timeBefore.text,
                                            addClient,
                                            callResponseId,callResultReasonId);
