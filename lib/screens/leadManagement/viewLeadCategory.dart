...
class ViewLeadCategory extends StatefulWidget {
  ...
  bool deleteLeads;
  ViewLeadCategory(
      this.token, this.createLeads, this.updateLeads, this.deleteLeads,
      {super.key});
  @override
        ...
        child: result == true
            ? Scaffold(
                                                            ...
                                                            onPressed:
                                                              ...
                                                              if (category.text
                                                                ...
                                                                Common.showProgressDialog(
                                                                    context,
                                                                    "Loading..");
                                                                AddLeadCategoryModel
                                                                    addCategory =
                                                                    await HttpService.addLeadCategory(
                                                                        widget
                                                                            .token,
                                                                        category
                                                                            .text);
                ...
                body: viewLeadsCategory != null
                    ? Container(
                        child: viewLeadsCategory!.data!.isNotEmpty
                            ? ListView.separated(
        ...
        builder: (BuildContext ctx) {
          return AlertDialog(
            ...
            actions: [
              ...
              TextButton(
                  onPressed: () async {
                    LeadCategoryDeleteModel deleteCategory =
                        await HttpService.deleteLeadCategory(
