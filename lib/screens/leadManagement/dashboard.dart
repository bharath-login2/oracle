                                                                      ...
                                                                      InkWell(
                                                                        onTap:
                                                                          ...
                                                                          Common.saveSharedPref(
                                                                              "statusWise",
                                                                              'no');
                                                                          LeadProgressbarModel object1 = await HttpService.leadProgressbar(
                                                                              widget.token,
                                                                              fromdate,
                                                                              todate,
                                                                              '1');
                                                              ...
                                                              ? Navigator.push(
                                                                  ...
                                                                  MaterialPageRoute(
                                                                      builder: (context) => ViewLeads(
                                                                          ...
                                                                          pageName:
                                                                              'Followup Leads',
                                                                          fromDate: DateTime(DateTime.now().year, DateTime.now().month - 3, DateTime.now().day)
                                                                              .toString(),
                                                                          toDate: todate
                                                                              .toString(),
                                                                          status:
