                        ...
                        child: Column(
                          children: [
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(left: 20,top: 45,bottom: 15),
                                child: Row(
                                  mainAxisAlignment:
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  child: Container(
                                      ...
                                      child:  Icon(isVisible==true?Icons.keyboard_arrow_down:Icons.keyboard_arrow_up)),
                                ),
                              ),
                            ),
                            const SizedBox(
                                                                          ...
                                                                          InkWell(
                                                                            onTap: () {
                                                                              Navigator.push(
                                                                                context,
                                                                                MaterialPageRoute(
                                                                                    builder: (context) => InvoiceList(widget.token.toString())),
                                                                              );
                                                                            ...
                                                                            onTap: () {
                                                                              Navigator.push(
                                                                                ...
                                                                                MaterialPageRoute(
                                                                                    builder:
                                                                                        (context) =>
                                                                                        TransferLeadReport(widget.token!,
                                                                                          true,
                                                                                          true,
                                                                                          true,
                                                                                          pageName:
