                                                                  ...
                                                                  : InkWell(
                                                                      onTap:
                                                                        ...
                                                                        Navigator
                                                                          ...
                                                                          context,
                                                                          MaterialPageRoute(
                                                                              builder: (context) => SearchPage(widget.token, updateLeadPermission1, deleteLeadPermission1, cloudCallPermission1, '')),
                                                                        ).then(
                                                                            (r) {
                                                                          getData(
                                                                              widget.token,
                                                                      ...
                                                                      onSelected:
                                                                        ...
                                                                        if (value ==
                                                                          ...
                                                                          Navigator
                                                                              .push(
                                                                            context,
                                                                            MaterialPageRoute(builder: (context) => const NotificationTemplateSettings()),
                                                                          );
                                                                        }
                                                                        if (value ==
                                                                            5) {
                                                                        ...
                                                                        if (value ==
                                                                          ...
                                                                          viewLeadPermission == 'true'
                                                                              ? Navigator.push(
                                                                                  context,
                                                                                  MaterialPageRoute(builder: (context) => ViewLeads(widget.token, updateLeadPermission1, deleteLeadPermission1, cloudCallPermission1, pageName: 'Missed Leads', fromDate: fromdate.toString(), toDate: todate.toString(), leadType: '1')),
                                                                                ).then((r) {
                                                                                  getData(widget.token, fromdate, todate);
                                                                                  if (loadmore == true) {
                                                                                    getStaffwise();
                                                                        ...
                                                                        if (value ==
                                                                          ...
                                                                          viewLeadPermission == 'true'
                                                                              ? Navigator.push(
                                                                                  context,
                                                                                  MaterialPageRoute(builder: (context) => ViewLeads(widget.token, updateLeadPermission1, deleteLeadPermission1, cloudCallPermission1, pageName: 'Transfer Leads', fromDate: fromdate.toString(), toDate: todate.toString(), leadType: '2')),
                                                                                ).then((r) {
                                                                                  getData(widget.token, fromdate, todate);
                                                                                  if (loadmore == true) {
                                                                                    getStaffwise();
                                                                        ...
                                                                        if (value ==
                                                                            10) {
                                                                          phoneCallLogPermission == 'true'
                                                                              ? Navigator.push(
                                                                                  context,
                                                                                  MaterialPageRoute(builder: (context) => CallLogs(widget.token, name, userId)),
                                                                                ).then((r) {
                                                                                  getData(widget.token, fromdate, todate);
                                                                                  if (loadmore == true) {
                                                                                    getStaffwise();
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          InkWell(
                                                                            onTap:
                                                                              ...
                                                                              await getLeadProgressbar(widget.token, fromdate, todate, '1');
                                                                              if (object1!.status == true) {
                                                                                if (context.mounted) {
                                                                                  Navigator.pop(context);
                                                                                  leadProgressbarDialog(context, "New Leads", "1", "");
                                                                                }
                                                                              }
                                                                            },
                                                                            child:
                                                                  ...
                                                                  ? Navigator
                                                                      ...
                                                                      MaterialPageRoute(
                                                                          builder: (context) => ViewLeads(
                                                                              ...
                                                                              fromDate: DateTime(DateTime.now().year, DateTime.now().month - 3, DateTime.now().day).toString(),
                                                                              toDate: todate.toString(),
                                                                              status: '2')),
                                                                    ).then((r) {
                                                                      getData(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          InkWell(
                                                                            onTap:
                                                                              ...
                                                                              Common.showProgressDialog(context, "Loading..");
                                                                              Common.saveSharedPref("statusWise", 'no');
                                                                              await getLeadProgressbar(widget.token, fromdate, todate, '2');
                                                                              if (object1!.status == true) {
                                                                                if (context.mounted) {
                                                                                  Navigator.pop(context);
                                                                                  leadProgressbarDialog(context, "Followup Leads", "2", "");
                                                                                }
                                                                              }
                                                                            },
                                                                            child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          InkWell(
                                                                            onTap:
                                                                              ...
                                                                              Common.showProgressDialog(context, "Loading..");
                                                                              Common.saveSharedPref("statusWise", 'no');
                                                                              await getLeadProgressbar(widget.token, fromdate, todate, '4');
                                                                              if (object1!.status == true) {
                                                                                if (context.mounted) {
                                                                                  Navigator.pop(context);
                                                                                  leadProgressbarDialog(context, "Closed Leads", "4", "");
                                                                                }
                                                                              }
                                                                            },
                                                                            child:
                                                                          ...
                                                                          InkWell(
                                                                            onTap:
                                                                              ...
                                                                              if (object1!.status == true) {
                                                                                if (context.mounted) {
                                                                                  Navigator.pop(context);
                                                                                  leadProgressbarDialog(context, "Total Called", "", "-1");
                                                                                }
                                                                              }
                                                                            },
                                                                            child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          GestureDetector(
                                                                            ...
                                                                            child:
                                                                                Tooltip(
                                                                              padding: const EdgeInsets.all(10),
                                                                              message: 'Transferred leads can be filtered \n using a specific date range to \n determine the count of Transferred \n leads within that period',
                                                                              key: _toolTipKey4,
                                                                              child: Container(
                                                                                width: 20,
                                                                                height: 20,
                                                                          ...
                                                                          InkWell(
                                                                            onTap:
                                                                              ...
                                                                              if (object1!.status == true) {
                                                                                if (context.mounted) {
                                                                                  Navigator.pop(context);
                                                                                  leadProgressbarDialog(context, "Transferred Leads", "", "2");
                                                                                }
                                                                              }
                                                                            },
                                                                            child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          InkWell(
                                                                            onTap:
                                                                              ...
                                                                              Common.showProgressDialog(context, "Loading..");
                                                                              Common.saveSharedPref("statusWise", 'no');
                                                                              await getLeadProgressbar(widget.token, fromdate, todate, '-3');
                                                                              if (object1!.status == true) {
                                                                                if (context.mounted) {
                                                                                  Navigator.pop(context);
                                                                                  leadProgressbarDialog(context, "Missed Leads", "", "1");
                                                                                }
                                                                              }
                                                                            },
                                                                            child:
                                                                      ...
                                                                      ? Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            ringStrokeWidth:
                                                                                25,
                                                                            centerText:
                                                                                leadDashboard!.data.currentLeadsCount.total,
                                                                            centerTextStyle:
                                                                        ...
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            Container(
                                                                              ...
                                                                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: Colors.lightBlue.shade100),
                                                                              child: Padding(
                                                                            ...
                                                                            Container(
                                                                              width: MediaQuery.of(context).size.width * .25,
                                                                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: Colors.orange.shade100),
                                                                              child: Padding(
                                                                                padding: const EdgeInsets.all(8.0),
                                                                                child: Column(
                                                                                  mainAxisAlignment: MainAxisAlignment.start,
                                                            ...
                                                            onTap: () {
                                                              if (list[i] ==
                                                                ...
                                                                Navigator.push(
                                                                  context,
                                                                  MaterialPageRoute(
                                                                      builder: (context) => InvoiceList(widget
                                                                          .token
                                                                          .toString())),
                                                                );
                                                              } else if (list[
                                                                ...
                                                                Navigator.push(
                                                                  context,
                                                                  MaterialPageRoute(
                                                                      builder: (context) => PendingInvoice(widget
                                                                          .token
                                                                          .toString())),
                                                                );
                                                              } else if (list[
                                                                ...
                                                                Navigator.push(
                                                                  context,
                                                                  MaterialPageRoute(
                                                                      builder: (context) => ReceiptList(widget
                                                                          .token
                                                                          .toString())),
                                                                );
                                                              } else {
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ...
                                                if (accountDashboard!.data
                                                    .incomeGraph.isNotEmpty)
                                                  ListView.builder(
                                                      shrinkWrap: true,
                                                      physics:
                                                          const NeverScrollableScrollPhysics(),
