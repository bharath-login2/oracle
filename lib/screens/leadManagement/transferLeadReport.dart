...
class TransferLeadReport extends StatefulWidget {
  ...
  TransferLeadReport(this.token,this.editLead,this.deleteLead,this.cloudCall,{this.pageName,this.page,this.pageSize,this.checkedCategoryItems,this.checkedCategoryItemsName,
    this.checkedCallResultItems,this.checkedCallResultItemsName,
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    items[index].lastCalledDate.toString(),
                                          ...
                                          Container(
                                            decoration: BoxDecoration(color: _colors[int.parse(items[index].callResultId!)], borderRadius: BorderRadius.circular(5)),
                                            child: Padding(
