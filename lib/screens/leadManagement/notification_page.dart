...
class NotificationPage extends StatefulWidget {
  ...
  bool cloudCall;
  NotificationPage(
      this.token, this.editLead, this.deleteLead, this.cloudCall,
      {Key? key})
      : super(key: key);
  @override
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    if (leadNotification!.data![i].isRead ==
                                        false) {
                                      await HttpService.readLeadNotification(
                                          widget.token,
                                          leadNotification!
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          leadNotification!.data![i].isRead ==
                                                  false
                                              ? Container(
                                                  height: 15,
                                                  width: 15,
