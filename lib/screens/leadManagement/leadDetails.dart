  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (widget.pageName == 'search') {
        ...
        else if (widget.pageName == 'transferLeads') {
          Navigator.push(
            context,
            MaterialPageRoute(
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => LeadNotificationPage(widget.token,
                    widget.editLead, widget.deleteLead, widget.cloudCall)),
          );
        }
        else {
          Navigator.push(
          ...
          body: leadDetails != null
            ...
            child: Column(
              children: [
                          ...
                          showDialog(
                              ...
                              builder: (BuildContext ctx) {
                                return AlertDialog(
                                  ...
                                  content:  Text(
                                      leadDetails!.data!.warningMessage.toString()),
                                  actions: [
                                    // The "Yes" button
                                    TextButton(
                                        onPressed: () {
                ...
                leadDetailsAdditional != null && listFolder != null && mileStone!=null
                    ? Column(
                  children: [
                    Container(
                      alignment: Alignment.center,
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            leadDetailsAdditional!.data!.followUpData![index].reason!=''? Padding(
                                            ...
                                            leadDetailsAdditional!.data!.followUpData![index].callResponse!=''? Text(
                                                        ...
                                                        showDialog(
                                                            ...
                                                            context) {
                                                              return AlertDialog(
                                                                ...
                                                                content:
                                                                const Text(
                                                                    'Are you sure to Remove this Voice?'),
                                                                actions: [
                                                                  // The "Yes" button
                                                                  TextButton(
                                                                      onPressed:
                                                          ...
                                                          actions: [
                                                            ...
                                                            audioCreateController.isRecording
                                                              ...
                                                              onPressed: () async {
                                                                ...
                                                                await HttpService.leadVoiceUpload(
                                                                  widget.token,
                                                                  widget.callMasterId,
                                                                  leadDetailsAdditional!.data!.followUpData![index].callDetailsId.toString(),
                                                                ...
                                                                if (uploadAudio.data ==
                                                                  ...
                                                                  audioCreateController.audioPath.value = '';
                                                                  audioCreateController.resetTimer();
                                                                  Common.toastMessaage(uploadAudio.message,
                                                                      Colors.green);
                    ...
                    if (selectedIndex == 3)
                      Column(
                        children: [
                          Padding(
                            ...
                            child: Container(
                              width: MediaQuery.of(
                                  ...
                                  .size
                                  .width *1,
                              decoration: BoxDecoration(color: Colors.white,borderRadius: BorderRadius.circular(6),border: Border.all(color: Colors.grey)),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.start,
                                ...
                                children: [
                                  Container(
                                    width: MediaQuery.of(
                                        ...
                                        .size
                                        .width *1,
                                    decoration: const BoxDecoration( color: Colors.grey,borderRadius: BorderRadius.only(topLeft:Radius.circular(5),topRight: Radius.circular(5))),
                                    child: const Padding(
                                      padding: EdgeInsets.all(10),
                                      child: Text('Basic Details ',style: TextStyle(fontSize: 15,color: Colors.white),),
                                    ),),
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          width: MediaQuery.of(
                                              ...
                                              .width *
                                              0.45,
                                          child: Text(leadDetails!.data!.clientName.toString(),
                          ...
                          leadDetailsAdditional!
                              .data!
                              .additionalFields!.isNotEmpty?Padding(
                            padding: const EdgeInsets.only(left: 10,right: 10),
                            child: Container(
                              width: MediaQuery.of(
                                  context)
                              ...
                              child: Column(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: const Padding(
                                      padding: EdgeInsets.all(10),
                                      child: Text('Additional Fields',style: TextStyle(fontSize: 15,color: Colors.white),),
                                    ),),
                                  const SizedBox(height: 10,),
                                  ListView.builder(
                                      shrinkWrap: true,
                                                          ...
                                                          child: RawMaterialButton(
                                                            onPressed: () async {
                                                              if (folderName.text.isEmpty) {
                                                                ...
                                                                CreateFolderModel createFolder = await HttpService.createFolder(widget.token, widget.callMasterId, path + folderName.text);
                                                            ...
                                                            child: RawMaterialButton(
                                                              onPressed: () async {
                                                                if (fileNameEdit.text.isEmpty) {
                                                                  ...
                                                                  RenameFolderModel createFolder = await HttpService.renameFolder(widget.token, widget.callMasterId, listPath, editableName, fileNameEdit.text, rawId);
                                                                  if (createFolder.data == true) {
                                          ...
                                          ctx) {
                                            return AlertDialog(
                                              ...
                                              actions: [
                                                ...
                                                TextButton(
                                                    onPressed: () async {
                                                      DeleteFolderAndFileModel deleteFolder = await HttpService.deleteLeadFolderAndFiles(widget.token, widget.callMasterId, deletePath, rawId);
