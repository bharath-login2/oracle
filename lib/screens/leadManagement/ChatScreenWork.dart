...
class _ChatScreenWorkState extends State<ChatScreenWork> {
  ...
  void _sendMessage() async {
    ...
    final success = await HttpService.sendWorkChatMessage(widget.groupId, msg,widget.assignedToId,);
    if (success) {
  ...
  try {
    final dateTime = DateTime.parse(dateTimeString.replaceFirst(RegExp(r':\d+$'), ''));
