...
class _WhatsappSettingsState extends State<WhatsappSettings> {
  ...
  getData() async {
    ...
    if (whatsappDetails != null) {
      ...
      accessToken.text =
          whatsappDetails!.data!.unofficial!.acessToken.toString();
      instanceId.text =
          whatsappDetails!.data!.unofficial!.qrCodeInstanceId.toString();
      ...
      phoneNumberId.text =
          whatsappDetails!.data!.official!.phoneNumberId.toString();
      accountId.text = whatsappDetails!.data!.official!.accountId.toString();
      permanentToken.text =
          whatsappDetails!.data!.official!.permanentToken.toString();
                                                                        ...
                                                                        if (connectivityResult
                                                                          ...
                                                                          if (connectivityResult.contains(ConnectivityResult.mobile) ||
                                                                            ...
                                                                            if (accessToken.text.isEmpty) {
                                                                              Common.toastMessaage('Access Token cannot be empty', Colors.red);
                                                                            } else if (instanceId.text.isEmpty) {
                                                                              Common.toastMessaage('Instance Id cannot be empty', Colors.red);
                                                                            } else if (phoneNumber1.text.isEmpty) {
                                                                              Common.toastMessaage('Phone Number cannot be empty', Colors.red);
                                                                            } else {
                                                                              if (mounted) {
                                                                                Common.showProgressDialog(context, "Loading..");
                                                                              }

                                                                              AddWhatsappSettingsModel addSettings = await HttpService.addWhatsappSettings(accessToken.text, instanceId.text, widget.token, '$code${phoneNumber1.text}');
                                                                              if (addSettings.status == true) {
                                                                                Common.toastMessaage(addSettings.message, Colors.green);
                                                                                if (mounted) {
                                                                                  Navigator.push(
                                                                                    context,
                                                                                    MaterialPageRoute(
                                                                                        builder: (context) => WhatsappSettings(
                                                                                              widget.token,
                                                                                            )),
                                                                                  );
                                                                                }
                                                                                ...
                                                                                Common.toastMessaage(addSettings.message, Colors.red);
                                                                              }
                                                                            }
                                                                          }
                                                                        } else {
